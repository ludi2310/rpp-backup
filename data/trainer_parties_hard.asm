...
MistyData:
	...
	db 25,POLIWRATH
	moveset DOUBLESLAP, ICE_BEAM, EARTHQUAKE, WATER_PULSE
	
	db 25,DEWGONG
	moveset HORN_ATTACK, ICE_BEAM, BODY_SLAM, WATER_PULSE
...
LtSurgeData:
	...
	db 34,ELECTABUZZ
	moveset ICE_PUNCH, THUNDERBOLT, LIGHT_SCREEN, CROSS_CHOP
...
BrunoData:
	...
	db 78,CHANSEY
	moveset SOFTBOILED, ICE_BEAM, THUNDERBOLT, THUNDER_WAVE
...
LanceData:
	...
	db 80,MOLTRES
	moveset FIRE_BLAST, RECOVER, AERIAL_ACE, SOLARBEAM
...
Green2Data:
	...
	db 43,GYARADOS
	moveset BITE, THRASH, WATERFALL, FLY
	...
	db 53,GYARADOS
	moveset CRUNCH, THRASH, WATERFALL, FLY
...
Green3Data:
	...
	db 80,STARMIE
	moveset PSYCHIC_M, THUNDER_WAVE, RECOVER, THUNDERBOLT
